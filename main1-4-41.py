# %% [markdown]
## Image Classification with ConvNeXt: Full Workflow with GPU Utilization, Batch Visualization, and Confusion Matrix
...
def visualize_batch_samples(loader, subcategories, title="Batch Samples"):
    """Visualize a batch of samples from a DataLoader"""
    ...
    for i in range(min(len(images), 10)):  # Display up to 10 images
        ...
        plt.imshow(images[i].permute(1, 2, 0).numpy())  # Convert tensor to HWC format
