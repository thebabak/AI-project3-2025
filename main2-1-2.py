# %% [markdown]
## Image Classification with CLIP Visual Encoder: Custom Classifier Comparison (1, 2, and 3 Layers)
...
def train_and_compare_models(dataset, subcategories, k_folds=5, batch_size=32, num_epochs=3, lr=1e-4):
...
results = train_and_compare_models(dataset, subcategories, k_folds=5, batch_size=32, num_epochs=3, lr=1e-4)